    ...
    <table>
      ...
      <tbody>
        <tr>
          ...
          <td>This is a real entry point, not a screenshot placeholder. The left side currently shows Python <code>task_brief_demo.py</code>, the right side shows Shell <code>clean_log_demo.sh</code>, and the experience scripts come from the formal directory <code>exec-gov-ai-skill-platform-script/tenant_1000/experience/</code>.</td>
        </tr>
        <tr>
  ...
  <section class="brand-grid brand-grid--two">
    <article class="brand-card">
      ...
      <ul class="brand-list">
        ...
        <li>The current demo on the experience page comes from <code>exec-gov-ai-skill-platform-script/tenant_1000/experience/</code> and is mapped through the manifest for hot swapping.</li>
