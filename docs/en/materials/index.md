...
<section class="brand-hero">
  <div>
    ...
    <div class="brand-chip-list">
      ...
      <span class="brand-chip">Kickoff options</span>
  ...
  <section class="brand-card">
    ...
    <div class="brand-link-grid">
      ...
      <a class="brand-link-card" href="./founder-profile.html">
        ...
        <p>Continue by checking delivery credibility and the source of the platform capability.</p>
      </a>
  ...
  <section class="brand-card">
    ...
    <h2>Background pages related to delivery credibility</h2>
    <div class="brand-link-grid">
