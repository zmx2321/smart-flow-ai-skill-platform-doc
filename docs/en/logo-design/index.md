...
<div class="brand-page-shell">
  <section class="brand-hero brand-hero--logo">
    <div>
      ...
      <div class="brand-hero__panel">
        ...
        <p>The logo should express intelligence, flow, control, and execution at the same time, while staying stable across docs, admin screens, the CLI, and small icon use.</p>
      </div>
      <p class="brand-lead">
        This is not a single icon sketch. It is a design brief for building one unified brand identity system around
        <strong>intelligent dispatch, experience as assets, safe control, and automated flow</strong>.
      </p>
      <div class="brand-chip-list">
        <span class="brand-chip">intelligent dispatch</span>
        <span class="brand-chip">experience as assets</span>
        <span class="brand-chip">safe control</span>
        <span class="brand-chip">automated flow</span>
      </div>
    </div>
  ...
  <section class="brand-grid brand-grid--four">
    <article class="brand-card">
      ...
      <h3>Intelligence</h3>
      <p>It should feel like a brain and decision center, not an ordinary decorative shape.</p>
    </article>
    <article class="brand-card">
      <p class="brand-kicker">Keyword</p>
      <h3>Flow</h3>
      <p>It should show data, energy, path, and direction rather than a static object.</p>
    </article>
    <article class="brand-card">
      <p class="brand-kicker">Keyword</p>
      <h3>Control</h3>
      <p>It should carry signals of boundary, aggregation, system dispatch, and controllable risk.</p>
    </article>
    <article class="brand-card">
      <p class="brand-kicker">Keyword</p>
      <h3>Precision</h3>
      <p>It should reflect efficient triggering and decisive execution, with the tension of "it will run the next second."</p>
    </article>
  </section>
  ...
  <section class="brand-card">
    ...
    <div class="brand-grid brand-grid--three">
      <article class="brand-card brand-card--nested">
        ...
        <h3>Main symbol</h3>
        <p>Use an abstract transformation of the right side of the Chinese character <code>智</code>, especially its inner square structure, and merge it with neural circuitry or data-flow patterns to form the core symbol.</p>
      </article>
      <article class="brand-card brand-card--nested">
        <span class="brand-pill">02</span>
        <h3>Encircling structure</h3>
        <p>Wrap or pierce the main symbol with a ring or an <code>∞</code> variant to express cycle, network, ecosystem, and controlled boundary.</p>
      </article>
      <article class="brand-card brand-card--nested">
        <span class="brand-pill">03</span>
        <h3>Accent marker</h3>
        <p>Add a minimal lightning or arrow mark at the core to represent dispatch trigger, intelligent decision, and precise execution.</p>
      </article>
    </div>
  </section>
  ...
  <section class="brand-card">
    ...
    <h2>Three design directions</h2>
    <div class="brand-direction-grid">
      <article class="brand-direction-card">
        <span class="brand-pill">Direction 01</span>
        <h3>Intelligent Cube</h3>
        <p>Emphasizes architecture, system thinking, and control. This direction fits a stronger platform and enterprise tone.</p>
        <ul class="brand-list">
          <li>Core image: a semi-transparent cube, internal luminous data flow, and a lightning-like trigger point</li>
          <li>Design language: firm geometry, clear structure, and strong internal tension</li>
          <li>Suggested colors: deep-space gray or matte silver with a blue-to-cyan gradient</li>
        </ul>
      </article>
      <article class="brand-direction-card">
        <span class="brand-pill">Direction 02</span>
        <h3>Neural Surge</h3>
        <p>Emphasizes the intelligent center, connection network, and dispatch diffusion, with a more frontier and agile AI feeling.</p>
        <ul class="brand-list">
          <li>Core image: a neural-network structure close to the letter <code>Z</code> with a central light point</li>
          <li>Design language: organic, luminous, with visible node connections and a stronger sense of intelligent life</li>
          <li>Suggested colors: a deep blue base with cyan or purple central highlights and a white dispatch wave</li>
        </ul>
      </article>
      <article class="brand-direction-card">
        ...
        <ul class="brand-list">
          ...
          <li>Suggested colors: a technology blue or deep-violet gradient with bright route bands and white beams</li>
        </ul>
      </article>
    </div>
  </section>
  ...
  <section class="brand-grid brand-grid--two">
    <article class="brand-card">
      ...
      <h2>The recommended path right now</h2>
      <p class="brand-lead">
    ...
    <article class="brand-card">
      ...
      <h2>The next visual assets to add</h2>
      <ul class="brand-list">
        <li>black-and-white directions and single-color standards</li>
        <li>reverse-color versions, favicon tests, and app-icon thumbnail tests</li>
        <li>icon-only versions and Chinese-English combination marks</li>
        <li>adaptation drafts for GitHub, web, admin, and CLI scenarios</li>
      </ul>
    </article>
  </section>
</div>
