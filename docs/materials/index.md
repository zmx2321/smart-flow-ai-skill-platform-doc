...
<section class="brand-hero">
    ...
    <div class="matrix-panel matrix-panel--contact">
      ...
      <div class="matrix-panel__canvas">
        ...
        <div class="matrix-panel__stack">
          <span class="matrix-panel__line"><span class="matrix-panel__key">30s</span><span class="matrix-panel__punct">:</span> <span class="matrix-panel__value matrix-panel__fn">what_it_is</span><span class="matrix-panel__sep"> / </span><span class="matrix-panel__value matrix-panel__ident">why_now</span></span>
          ...
          <span class="matrix-panel__line"><span class="matrix-panel__key">entry</span><span class="matrix-panel__punct">:</span> <span class="matrix-panel__value matrix-panel__fn">pitch</span><span class="matrix-panel__sep"> / </span><span class="matrix-panel__value matrix-panel__fn">value</span><span class="matrix-panel__sep"> / </span><span class="matrix-panel__value matrix-panel__ident">background</span></span>
        </div>
        <div class="matrix-panel__callout">CLEAR MATERIALS FOR REAL DECISIONS</div>
      </div>
  ...
  <section class="brand-grid brand-grid--three">
    ...
    <article class="brand-card">
      ...
      <h2>介绍提纲</h2>
      <p>回答 ExecGov 是什么、解决什么问题，以及它与普通聊天页或零散脚本工具的差异。</p>
    </article>
    <article class="brand-card">
    ...
    <article class="brand-card">
      ...
      <h2>交付背景与项目经历</h2>
      <p>回答这套平台背后是否有真实交付沉淀，是否理解权限、上线、审计和交接这类问题。</p>
    </article>
    <article class="brand-card">
      <p class="brand-kicker">Overview</p>
      <h2>背景概览</h2>
      <p>概览当前长期主线、项目切入范围和当前边界，适合第一次接触时快速浏览。</p>
    </article>
    <article class="brand-card">
    ...
    <table>
      ...
      <tbody>
        ...
        <tr>
          ...
          <td>客户、项目负责人、场景沟通对象</td>
        </tr>
        <tr>
          <td>背后有没有真实交付能力</td>
          <td><a href="./founder-profile.html">交付背景与项目经历</a></td>
          <td>长期能力主线、项目沉淀、平台能力来源</td>
          <td>技术负责人、项目负责人</td>
        </tr>
        <tr>
          <td>先快速看技术背景是否匹配</td>
          <td><a href="./founder-card.html">背景概览</a></td>
          <td>当前主线能力、适合切入的项目类型和合作边界</td>
          <td>客户、项目负责人</td>
        </tr>
        <tr>
          <td>要看更标准的技术履历</td>
          <td><a href="./resume-public.html">项目与履历</a></td>
          <td>技能栈、工作经历、代表项目和公开信息</td>
  ...
  <section class="brand-card">
    <p class="brand-kicker">Background Pack</p>
    <h2>交付背景相关资料</h2>
    <div class="brand-link-grid">
      <a class="brand-link-card" href="./founder-card.html">
        <span>Overview</span>
        <strong>背景概览</strong>
        <p>适合先快速判断当前能力和切入范围。</p>
      </a>
      <a class="brand-link-card" href="./founder-profile.html">
        <span>Background</span>
        <strong>交付背景与项目经历</strong>
        <p>适合继续看长期主线、项目沉淀和平台形成逻辑。</p>
      </a>
