  ...
  <section class="brand-hero">
    <div>
      ...
      <div class="brand-hero__panel">
        ...
        <p>当前最稳的销售路径是：个人先走免费线，个人继续使用但还没进入正式协作时走本地脚本位增购，正式团队再进入月租 / 年租单独租户，企业与私有化按场景单独评估。</p>
      </div>
      <p class="brand-lead">
      ...
      <div class="brand-grid brand-grid--single">
        <article class="brand-hero__panel">
          ...
          <ul class="brand-list">
            ...
            <li>团队版月租 / 年租已经有升级入口，会把用户引导到标准 SaaS 单独租户注册页。</li>
        ...
        <article class="brand-hero__panel">
          ...
          <ul class="brand-list">
            ...
            <li>不能把团队版月租 / 年租价格写死在资料页，因为最终价格和付款页以目标租户注册页当页展示为准。</li>
          </ul>
        </article>
      </div>
    </div>
  ...
  <section class="brand-grid brand-grid--four">
    ...
    <article class="brand-card">
      ...
      <ul class="brand-list">
        ...
        <li>不会继续挂在个人免费隐藏租户里，而是跳转到标准 SaaS 单独租户注册页。</li>
    ...
    <table>
      ...
      <tbody>
        ...
        <tr>
          <td>团队版月租 / 年租</td>
          <td>不在资料页写死</td>
          <td>从升级方案页跳转到标准 SaaS 单独租户注册页</td>
...
| 团队版月租 | 想先验证正式协作的团队 | 单独租户注册入口、正式团队使用路径、更适合多人协作 | 价格和付款页以注册页当页展示为准 |
...
| 企业版 / 私有化 | 有内网、合规、审批或正式交付要求的客户 | 更适合按项目边界、部署方式和治理要求推进 | 不走标准会员口径，需要单独评估 |
  ...
  <section class="brand-card">
    ...
    <div class="step-list">
      ...
      <div class="step-item">
        ...
        <div class="step-item__desc">这一步的核心不是“又买一个套餐”，而是从个人隐藏租户切到标准 SaaS 单独租户。</div>
      </div>
      <div class="step-item">
  ...
  <section class="brand-grid brand-grid--two">
    <article class="brand-card">
      ...
      <p>因为当前代码事实是：团队版升级路径会跳到标准 SaaS 单独租户注册页，最终价格、付款页和服务周期应以那个入口当页展示为准。资料页如果提前写死，反而容易和真实入口不一致。</p>
    </article>
    <article class="brand-card">
      <p class="brand-kicker">FAQ 02</p>
      <h2>本地脚本位增购算不算正式会员</h2>
      <p>不算。它是个人免费版里的轻量增购，解决的是个人空间脚本位扩容问题；如果要进入正式团队协作，仍应走团队版月租 / 年租单独租户注册路径。</p>
    </article>
  </section>
