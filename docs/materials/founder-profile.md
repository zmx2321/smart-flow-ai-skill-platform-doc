...
<div class="brand-page-shell brand-page-shell--founder-profile">
  ...
  <section class="brand-grid brand-grid--three">
    ...
    <article class="brand-card">
      ...
      <h2>适合做治理平台</h2>
      <p>做过太多“脚本能跑但不能交付”的项目场景，因此对权限边界、执行确认、审计留痕和上线交接有更强的敏感度。</p>
    </article>
  </section>
  ...
  <section class="brand-grid brand-grid--two">
    <article class="brand-card">
      ...
      <h2>对项目的直接价值</h2>
      <ul class="brand-list">
        <li>能从真实流程切入，而不是先讲一个范围过大的平台故事。</li>
        <li>对权限、审计、责任边界和执行风险有明确意识，适合进入正式交付环境。</li>
        <li>能把脚本能力、页面入口、数据流转和交付物放在同一个视角下收口。</li>
        <li>习惯先做一个可运行、可验证、可交接的最小闭环，再决定第二阶段扩展。</li>
      </ul>
    </article>
    <article class="brand-card">
    ...
    <table>
      ...
      <tbody>
        ...
        <tr>
          ...
          <td>环亚数字经济研究院 / Web 前端开发</td>
          <td>Mapbox、大屏、中后台、小程序</td>
          <td>商业云交投大脑、商铺管理、能源管控、UniApp 小程序、Vue3 / Vite / Element Plus 中后台交付。</td>
        </tr>
        <tr>
          <td>2020.10 - 2021.07</td>
          <td>北京天天智慧智电科技 / Web 前端开发</td>
          <td>电力后台、驾驶舱、数据采集</td>
          <td>售电管理平台、合同审批、多 Tab 复杂交互、数据驾驶舱、合法授权场景下的数据采集与入库。</td>
        </tr>
        <tr>
          <td>2019.10 - 2020.09</td>
          <td>杭州德慧信息技术 / Web 前端开发 / 技术负责人</td>
          <td>Cesium、三维可视化、团队交付</td>
          <td>牵头前端框架与规范、带队完成多个政企 GIS 三维项目，覆盖模型加载、单体化、视频投影和 IoT 数据联动。</td>
        </tr>
        <tr>
          <td>2015 - 2019</td>
          <td>更早期经历</td>
  ...
  <section class="brand-grid brand-grid--two">
    <article class="brand-card">
      ...
      <h2>代表性项目类型</h2>
      <ul class="brand-list">
        <li>无线网质量评估系统：地图可视化、空间数据、业务数据联动与自动化处理共同落地。</li>
  ...
  <section class="brand-grid brand-grid--two">
    ...
    <article class="brand-card">
      ...
      <h2>推进方式</h2>
      <ul class="brand-list">
        <li>先拿一个真实流程收口范围，不在第一轮就把项目范围铺得过宽。</li>
        <li>先把输入、输出、周期、边界和不包含项说明白，再谈报价和扩展阶段。</li>
        <li>优先做可交付、可维护、能复用的东西，不优先堆叠展示型功能。</li>
        <li>如果场景不适合做，倾向于直接说明，不把沟通拖进模糊状态。</li>
      </ul>
    </article>
  </section>
